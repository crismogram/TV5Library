...
public partial class Report_Default : System.Web.UI.Page
{
    ...
    public void ConfigureExport()
    {
        ...
        RadGrid1.ExportSettings.FileName = "P2 Tapes Reports";
        RadGrid1.MasterTableView.GetColumn("P2 Number").Visible = CB1.Checked;
        RadGrid1.MasterTableView.GetColumn("Serial Number").Visible = CB2.Checked;
